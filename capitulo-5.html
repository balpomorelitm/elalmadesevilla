...
<body>
    <div class="container">
        ...
        <h1>Chapter 5: Un error en clase</h1>
        ...
        <nav class="chapter-nav">
            <a href="capitulo-4.html" class="prev-chapter">← Previous: Chapter 4</a>
            <a href="capitulo-6.html" class="next-chapter">Next: Chapter 6 →</a>
        </nav>
    </div>
